...
tileset = image.load("atividade-12-Mapas.Pygame/TileSet.png")
tileset= transform.scale(tileset, (20 * tile_size_joguinho, 12 * tile_size_joguinho)) 
placaP = image.load("atividade-12-Mapas.Pygame/7.png")
placaP = transform.scale(placaP, (tile_size_joguinho, tile_size_joguinho))
fundo= image.load("atividade-12-Mapas.Pygame/2.png")
fundo= transform.scale(fundo, (3600, 720))
fundo2=image.load("atividade-12-Mapas.Pygame/3.png")
fundo2= transform.scale(fundo2, (3600, 720))
castelo= image.load("atividade-12-Mapas.Pygame/castelo.png")
castelo= transform.scale(castelo, (600, 400))
encostouCastelo= False

#dino
dino_sheet= image.load("atividade-11-Animações.Pygame/Dinoi.png")
...
arq = open("./atividade-12-Mapas.Pygame/Map.txt", "r")
mapa_joguinho = []
for linha in arq:
